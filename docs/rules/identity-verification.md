...
- This step follows Profile setup and an intro splash screen (identity-intro) that sets expectations before asking for ID details, and precedes Address info.
